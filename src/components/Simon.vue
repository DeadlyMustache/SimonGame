      ...
      return {
          simon: {
              ...
              difficultyLevels: new Map([
                ['dlEasy', { name: "Легко", panelFiringTime: 1500, panelCoolingTime: 700, timeGapBetweenRounds: 800 }],
                ['dlNormal', { name: "Нормально", panelFiringTime: 1000, panelCoolingTime: 500, timeGapBetweenRounds: 600 }],
                ['dlHard', { name: "Тяжело", panelFiringTime: 700, panelCoolingTime: 200, timeGapBetweenRounds: 400 }]
              ]),
...
.simon.allow {
  background-color: rgb(81, 240, 81);
}
